...
public:
	...
	bool UsesRegvars;						// register variables
	bool UsesStackParms;
...
public:
	...
	void GenerateAddOnto(Operand* dst, Operand* src, int sz = 0);
	...
	Operand* PatchEnter(OCODE* pe, CSet* rmask);
};
...
class Qupls4CodeGenerator : public CodeGenerator
{
public:
	void banner();
	Operand* MakeBoolean(Operand* oper);
